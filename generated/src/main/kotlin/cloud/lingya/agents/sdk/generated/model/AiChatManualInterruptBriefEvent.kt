...
data class AiChatManualInterruptBriefEvent (

    /* 类型判别值 / type discriminator。 */
    @param:JsonProperty("type")
    @get:JsonProperty("type")
    val type: AiChatManualInterruptBriefEvent.Type
     ...
     * 类型判别值 / type discriminator。
     *
     * Values: manualMinusInterrupt,unknown_default_open_api
     */
    enum class Type(@get:JsonValue val value: kotlin.String) {
        @JsonProperty(value = "manual-interrupt") manualMinusInterrupt("manual-interrupt"),
