...
data class DoubleChartColumn (
    ...
    val type: DoubleChartColumn.Type,

    /* 字段 values / values field。 */
    @param:JsonProperty("values")
    @get:JsonProperty("values")
    val propertyValues: kotlin.collections.List<kotlin.Double?>
     ...
     * 类型判别值 / type discriminator。
     *
     * Values: DOUBLE,unknown_default_open_api
     */
