...
public class LingyaAgentsClient @JvmOverloads constructor(
    ...
    public fun forUser(externalUserId: String): LingyaAgentsUserClient {
        ...
        return LingyaAgentsUserClient(baseUrl, channelId, builder.build(), objectMapper)
    }

    /** Returns the Java-friendly blocking facade for one external user. */
    public fun blockingForUser(externalUserId: String): BlockingLingyaAgentsUserClient =
        BlockingLingyaAgentsUserClient(forUser(externalUserId))
